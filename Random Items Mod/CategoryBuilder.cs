...
public class CategoryBuilder
{
    /// <summary>
    /// </summary>
    /// <param name="Random Items Mod">New category name</param>
    /// <param name="All the Mod Items.">Description of the new category</param>
    /// <param name="VB.png">New category icon</param>
